...
WebUI.click(findTestObject('Page_Swag Labs/div_Accepted usernames arestandard_userlock_f87578'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/button_Back to products'), 'Back to products')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Backpack_1'), 'Sauce Labs Backpack')
